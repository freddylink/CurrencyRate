...
namespace Frontend
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CurrencyRateDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            services.AddScoped<ICurrencyRateService, CurrencyRateService>();
            services.AddScoped<NationalBankUa>();
            services.AddScoped<NationalBankKz>();
            services.AddScoped<OpenExchangeRateBankClient>();
            services.AddScoped<BankClientFactory>();
            services.AddScoped<BankClientDataProvider>();
